...
9993        FORMAT('               with a 1hr NO2/NOx Ratio ',
     &              'of ',F6.3)
...
9994        FORMAT('               with an Annual NO2/NOx Ratio ',
     ...
     &              'NO2.'
         END IF
         IF (.NOT.PVMRM .AND. .NOT.OLM .AND. .NOT.ARM .AND. .NOT.ARM2 
     &       .AND. POLLUT.NE.'NO2') THEN
            IF (URBAN) THEN
...
9092              FORMAT(12X,I6,' Capped Stack(s); and ',I6,
     ...
     &                 L_LowWind1 .OR. L_LowWind2 .OR. L_AdjUstar) THEN
         WRITE(IOUNT,9099)
     ...
     &                                     'includes CCVR substitions'
      END IF
      IF (L_TEMP_Sub) THEN
         WRITE(IOUNT,*) '        TEMP_Sub - Meteorological data ',
     &                                     'includes TEMP substitions'
      END IF
C*#
      WRITE(IOUNT,9099)
      IF (FLGPOL) THEN
